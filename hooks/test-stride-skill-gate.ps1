# test-stride-skill-gate.ps1 — tests for stride-skill-gate.ps1
#
# Mirrors test-stride-skill-gate.sh on PowerShell. Each test creates an
# isolated temp project dir, optionally writes a marker, pipes a Skill
# PreToolUse fixture into the gate, and asserts on exit code and stdout.
#
...
function Invoke-Gate {
    ...
    $inputJson = '{"tool_name":"Skill","tool_input":{"skill":"' + $SkillName + '"}}'
...
Write-Host 'Running stride-skill-gate.ps1 tests...'
Write-Host ''
